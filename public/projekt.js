...
function loadPlayerData(){
		...
		var getPlayerName = prompt("Sisesta mängija nimi");

		if(getPlayerName === null || getPlayerName === ""){
			getPlayerName = "Nimetu";
...
function updateScore(){
	var playerscore=document.getElementById("playerScore").innerHTML="SKOOR: "+score;
	var sumTotal=document.getElementById("TotalSum").innerHTML="MAATRIKSEID KOKKU: "+sumOfExercises;
	var wrongMatrices=document.getElementById("wrongAnswers").innerHTML="VIGU: "+errorCount;
}
