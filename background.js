...
for (var i in iconTypeS) {
    ...
    ICONS.ACTION.CURRENT[iconType] = "ikoonid/" + iconType + ".png";
    ICONS.ACTION.PENDING[iconType] = "ikoonid/" + iconType + "_pending.png";
    ICONS.FULL[iconType] = "ikoonid/" + iconType + "_full.png";
}
/*
  Models
*/
