				...
				{$game = $_POST["Game"];
					$selection = $_POST["Media"];
						...
						if($selection == "Console"){
							$data->deleteEntryConsole ($Helper->cleanInput($email), $Helper->cleanInput($game));}
						if($selection == "Portable"){
							$data->deleteEntryPortable ($Helper->cleanInput($email), $Helper->cleanInput($game));}
						if($selection == "Board"){
							$data->deleteEntryBoard ($Helper->cleanInput($email), $Helper->cleanInput($game));}
						if($selection == "Card"){
							$data->deleteEntryCard ($Helper->cleanInput($email), $Helper->cleanInput($game));}
